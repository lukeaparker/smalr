...
def create_app(mode='default'):
    ...
    app = Flask(__name__, template_folder="smalr/views/templates",
                static_folder="smalr/views/static")
    ...
    with app.app_context():
        ...
        from smalr.views.views import views as views_blueprint
        app.register_blueprint(views_blueprint, url_prefix="")

        # Register api blueprint
        from smalr.api.api import api as api_blueprint
